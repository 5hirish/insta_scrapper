...
class AccountTests(ApiTestBase):
    ...
    @compat_mock.patch('instascrape.Client.csrftoken',
    ...
    def test_login_mock(self, csrftoken):
        ...
        with compat_mock.patch('instascrape.Client.generate_uuid') as generate_uuid_mock, \
    ...
    @compat_mock.patch('instascrape.Client._call_api')
    ...
    @compat_mock.patch('instascrape.endpoints.accounts.compat_urllib_request.OpenerDirector.open')
    def test_change_profile_picture_mock(self, opener):
        ...
        with compat_mock.patch('instascrape.Client._read_response') as read_response, \
                compat_mock.patch('instascrape.Client.default_headers') as default_headers, \
                compat_mock.patch('instascrape.endpoints.accounts.compat_urllib_request.Request') \
                as request, \
