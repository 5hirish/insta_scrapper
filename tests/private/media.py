...
class MediaTests(ApiTestBase):
    ...
    def test_post_comment_mock(self, call_api):
        ...
        with compat_mock.patch('instascrape.endpoints.media.gen_user_breadcrumb') \
                as gen_user_breadcrumb_mock, \
                compat_mock.patch('instascrape.Client.generate_uuid')\
    ...
    def test_media_seen2_mock(self, call_api):
        ...
        with compat_mock.patch('instascrape.endpoints.media.randint') as randint_mock, \
                compat_mock.patch('instascrape.endpoints.media.time.time') as time_mock:
